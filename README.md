...
* Artifacts.use() - [createSingleArtifact](createSingleArtifact), [appendToMultipleArtifact](appendToMultipleArtifact), [workerEnabledTransformation](workerEnabledTransformation), [transformManifest](transformManifest), [transformDirectory](transformDirectory), [listenToArtifacts](listenToArtifacts)
...
* TaskBasedOperation.wiredWith() - [createSingleArtifact](createSingleArtifact), [listenToArtifacts](listenToArtifacts)
